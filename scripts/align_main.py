...
import time
import gc
#sys.path.append("/home/codee/scratch/feabas/")
# Remove unwanted paths dynamically
sys.path = [p for p in sys.path if "/lustre07/scratch/codee/feabas/" not in p]
sys.path = [p for p in sys.path if p != "/lustre07/scratch/codee"]
sys.path.insert(0, "/home/codee/scratch/feabas/")
import sys
